...
<form method="post" action="biodata.php" enctype="multipart/form-data">
	...
	<table>
		<tr>
			...
			<td> 
				<label>:</label>
				<input type="text" name="dialect" size="54" required>
			</td>
		...
		<tr>
			...
			<td> 
				<label>:</label>
				<input type="text" name="notif" size="54" required>
			</td>
		</tr>
	</table>
<br>
	...
	<table>
		...
		<tr>
			...
			<tr>
				<td></td>
				<td>
					<button  value="Save Record" name="savebtn" style="width: 200px; margin-top: 10px; height: 30px;margin-left: 125px;">Save Record</button>
				</td>
			</tr>
	</table>
